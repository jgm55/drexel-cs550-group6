...
class FunCall(Expr):
    ...
    def eval(self, nt, ft):
        ...
        print "applying: ",nt[self.name]
		
        return nt[self.name].apply(nt, ft, self.argList)
...
class Proc:
    ...
    def apply(self, nt, ft, args):
        ...
        self.body.eval(newContext, newFt)
        self.callingEnvironment = newContext
